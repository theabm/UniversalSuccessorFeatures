...
class FeatureGoalWeightAugmentedUSF(torch.nn.Module):
    """Feature goal weight network with three layers for the psi
    calculation."""
    ...
    def forward(self, features, policy_goal_position, env_goal_weights):
        ...
        joined_representation = torch.cat((feature_encoding, goal_position_features), dim=1)
...
if __name__ == "__main__":
    my_dqn = FeatureGoalWeightAugmentedUSF()
    print(my_dqn)
