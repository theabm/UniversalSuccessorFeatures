...
q_gt_g1_s9 = [0.500,1.000,1.000,0.500] #goal state
...
q_gt_g2_s6 = [0.0625,0.250,0.125,0.250] #goal state
...
def test_training(
    num_episodes=50,
    goal_1_position=goal_1_position,
    goal_2_position=goal_2_position,
    env = my_test_env,
